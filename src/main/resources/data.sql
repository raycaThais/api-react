...
-- ========================== criando tabela de codigo
-- Primeiro, crie a tabela 'conta'
...
-- Depois, crie a tabela 'codigo_recuperacao'
CREATE TABLE IF NOT EXISTS codigo_recuperacao (
    id BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    codigo VARCHAR(255),
    data_expiracao TIMESTAMP,
    conta_id BIGINT UNIQUE,
    CONSTRAINT fk_codigo_recuperacao_conta FOREIGN KEY (conta_id) REFERENCES conta(id)
);
